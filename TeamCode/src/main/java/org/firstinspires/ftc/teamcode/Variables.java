...
public class Variables {
    ...
    public static final double sorter2Position = 0.19;
    public static final double sorter3Position = 0.38;
    public static final double sorter1OuttakePosition = 0.27;
    public static final double sorter2OuttakePosition = 0.465;
    public static final double sorter3OuttakePosition = 0.08;
